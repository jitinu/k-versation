...
update public.site_stats set members_offset = 70 where id = 1;

insert into public.videos (
  id, slug, section, title, subtitle, description, video_url, thumbnail_url,
  duration_seconds, published_at, view_offset
)
values
  (
    ...
    'conversation',
    'Todd Park on fixing American healthcare',
  ...
  (
    ...
    'conversation',
    'Sera Shim on the business of K-pop',
  ...
  (
    ...
    'conversation',
    'Why Korea doesn''t make NBA players',
  ...
  (
    ...
    'conversation',
    'Yoonjong Park: coding was the easy part',
  ...
  (
    ...
    'conversation',
    'Jamie Gao on Taiwan''s exam culture',
  ...
  (
    ...
    'conversation',
    'Heejung & Ali on pressure in two countries',
  ...
  (
    ...
    'conversation',
    'CodeTree''s Lee Seung-yong on AI and coding',
  ...
  (
    ...
    'conversation',
    'Diane Rosenberg on kids, phones, and school',
  ...
  (
    ...
    'conversation',
    'Seungheon Choi on leaving the safe path',
